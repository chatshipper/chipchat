...
class ChipChat extends RestAPI(Server(EventEmitter2)) {
    ...
    /**
       ...
       @param {string|Buffer} [options.jwtKey] - Key used to verify the access token's
         signature (HS shared secret or RS/ES public key). When set, the token is verified
         with {@link ChipChat.verifyJwt}; otherwise its claims are decoded without verification.
