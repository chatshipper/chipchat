...
class ChipChat extends RestAPI(Server(EventEmitter2)) {
    ...
    constructor(options = {}) {
        ...
        /**
         * @property {string} optional, version The API version.
         */
        this.version = opts.version || process.env.APIVERSION || 2;
    ...
    _getActionsObject(convId) {
        ...
        return Object.assign({}, this._conversations[convId] || {}, {
            ...
            ask: (q, cb) => {
                ...
                return this.send(convId, q, afterSendingMessage(cb || Promise.resolve));
            }
        });
    }
}
